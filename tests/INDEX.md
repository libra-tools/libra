...
| `agent_bridge_protocol_test` | 1 | bridge protocol v1.1: 21-method allowlist including additive `memory.recall`, v1 limits (256 KiB frame, 64 in-flight, 64-event batch, page 100), initialize/major-mismatch/unknown-method/parse rejection | `src/internal/ai/agent_bridge/protocol.rs` |
